<div id="js-header" class="u-header u-header--static dark-header">
    <div
        ...
        <div class="container">
            <div
                ...
                <span style="text-transform: none;">
                    <span class="datetime-string">{!! App\Services\Main\Service::date_info() !!}</span>
                </span>
                </div>
                <!-- End Languages -->
                <!-- Start Search -->
                ...
                <div class="col-auto">
                    ...
                    <div class="d-inline-block g-valign-middle g-pos-rel g-top-minus-1">
                        ...
                        <!-- Start Search Form -->
                        <form action="{{ route("post.index")  }}" method="get" id="searchform-1"
                            ...
                            <div class="input-group g-brd-primary--focus">
                                <input class="form-control rounded-0 u-form-control g-brd-gray-light-v3" type="search"
                                       name="search" value="{{ htmlspecialchars(urldecode(trim(@$_GET['search'])))  }}"
                                       placeholder="Поле поиска ..." required>
